...
Function Jons_Code
{
    ...
    #YO YO YO YO Write YO code here!!!!!!!
...
#####
#
# This is where you start the script. Above it sets the folder to store the files 
# It next asks how to get the files either domain or file or manual.
# You will add your code in Jons_Code and then below run . Jons_Code
#
#####
